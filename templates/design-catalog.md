...
[DESIGN.md](https://stitch.withgoogle.com/docs/design-md/overview/) is a concept from Google Stitch: a plain-text design system document that AI agents read to generate consistent UI. It is just a markdown file. No Figma exports, no JSON schemas, no special tooling.
